	...
	return (
		<Box pt="8vh">
			...
			>
				...
				></div>
				<Flex flexDir="column" width="70%" textAlign="center">
					<Text py="5" fontSize="20">
						How the adventure ended will be seen anon. Aouda was
						anxious, though she said nothing.
					</Text>
              ...
              simply glorious. The captain had said.`}
					...
					<Text fontSize="18">
						...
						stationary in the north-east.
					</Text>
					{/* </Stack> */}
					<Text py="3rem" fontSize="18">
						{`As for Passepartout, he thought Mr. Fogg’s manoeuvre simply
              glorious. The captain had said “between eleven and twelve knots,”
              and the Henrietta confirmed his prediction. How the adventure
              ended will be seen anon. Aouda was anxious, though she said
			...
			>
				...
				></div>
				<Text px="10%" py="5" fontSize="20" maxW="85%">
